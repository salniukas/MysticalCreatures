...
sub Read_Config {
	...
	# Standard, Mandrake and Debian package :	"/home/dh00143/domains/beta.mistinesbutybes.lt/awstats/.data"
	# Other possible directories :				"/usr/local/etc/awstats", "/etc"
	# FHS standard, Suse package : 				"/etc/opt/awstats"
	my $configdir         = shift;
	my @PossibleConfigDir = (
			"$DIR",
			"/home/dh00143/domains/beta.mistinesbutybes.lt/awstats/.data",
